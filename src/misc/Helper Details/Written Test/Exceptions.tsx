...
export function CbtExceptions() {
  return (
    <div>
      Here are some solutions for handling possible exceptions in written test:
      <ol
        style={{
          listStyle: "number",
          paddingLeft: "2.5rem",
      ...
      >
        <li>
          ...
          >
            ...
            <li>
              Now, select the table as <code>Print Written Test</code>, then
        ...
        <li>
          ...
          >
            ...
            <li>
              Now, select the table as <code>Paid Written Test</code>, then
              enter the roll number and search.
            </li>
            <li>
              Here you can edit, delete records from the registered table of
              written test. You can find the related actions at the end of each
              row.
            </li>
            <li>
