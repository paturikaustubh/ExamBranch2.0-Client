...
export function RevalExceptions() {
  return (
    <div>
      Here are some solutions for handling possible exceptions in revaluation:
      <ol
        style={{
          listStyle: "number",
          paddingLeft: "2.5rem",
      ...
      >
        <li>
          ...
          >
            ...
            <li>
              Now, select the table as <code>Print Revaluation</code>, then
        ...
        <li>
          ...
          >
            ...
            <li>
              Now, select the table as <code>Paid Revaluation</code>, then enter
              the roll number and search.
            </li>
            <li>
              Here you can edit, delete records from the registered table of
              revaluation. You can find the related actions at the end of each
              row.
            </li>
            <li>
